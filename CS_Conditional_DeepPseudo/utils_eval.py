...
This 'utils_eval.py' provides time-dependent Concordance index and Brier Score:
...
##### CENSORING PROBABILITY USED FOR CALCULATING WEIGHTED C-INDEX & BRIER-SCORE
...
# WEIGHTED BRIER SCORE CALCULATION: this account for the weighted average for unbaised estimation
